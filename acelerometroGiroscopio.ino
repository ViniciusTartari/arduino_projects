/*
* Codigo exemplo de utilizacao de sensor MPU6050 (acelerometro, giroscópio e temperatura).
* Utiliza biblioteca Wire.
*/
...
void loop()
{
  ...
  //Envia valores lidos do acelerômetro para o monitor serial
  Serial.print("Acel:");
  Serial.print("  X:");
  Serial.print(acelX);
  Serial.print("\tY:");
  ...
  //Envia valores lidos do giroscópio para o monitor serial
  Serial.print("\tGiro:");
  Serial.print("  X:");
  Serial.print(giroX);
  Serial.print("\tY:");
  ...
  //Envia valor da temperatura em graus Celsius para o monitor serial
  Serial.print("\tTemperatura: ");
  Serial.println(temperatura / 340.00 + 36.53);

  //Aguarda 500 ms para releitura
  delay(500);
}